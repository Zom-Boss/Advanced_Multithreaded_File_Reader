    ...
    private:
        ...
        void monitor_file()
        {
            ...
            while (!stop_monitoring)
            {
                ...
                // If current time (the time of last write to the file) is not the same as last modification time, it means content
                // has changed in atleast one of the thread's chunk
